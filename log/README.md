...
| ❌ `Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-Q4_K_P.gguf` | 27B | 4 | Hallucinates a stone marker Day 1 and all 3 hold a 19:00 vigil for it over four days; grasps the economy ("I can't eat because I'm the only one working") yet gets 1 meal and 1 sale in 286 actions, Alice and Bob starve. Flawless JSON, 21 factual diaries, prose degenerates into "And the light is the light" |
